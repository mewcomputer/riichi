...
pub fn openapi_document_value() -> Value {
    let mut document = json!({
        ...
        "components": {"schemas": {
            ...
            "Notification": {"type": "object", "required": ["id", "recipient_account_id", "kind", "payload", "created_at"], "properties": {"id": {"type": "string", "format": "uuid"}, "recipient_account_id": {"type": "string", "format": "uuid"}, "kind": {"type": "string", "enum": ["comment", "approval", "assignment", "invitation", "takeover", "lease"]}, "project_id": {"type": ["string", "null"], "format": "uuid"}, "issue_id": {"type": ["string", "null"], "format": "uuid"}, "actor_id": {"type": ["string", "null"], "format": "uuid"}, "payload": {"type": "object"}, "created_at": {"type": "string", "format": "date-time"}, "read_at": {"type": ["string", "null"], "format": "date-time"}}},
